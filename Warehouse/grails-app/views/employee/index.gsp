		...
		<div id="list-employee" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="currentSalary" title="${message(code: 'employee.currentSalary.label', default: 'Current Salary')}" />
					
						<th><g:message code="employee.loginInfo.label" default="Login Info" /></th>
				...
				<g:each in="${employeeInstanceList}" status="i" var="employeeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: employeeInstance, field: "currentSalary")}</td>
					
						<td>${fieldValue(bean: employeeInstance, field: "loginInfo")}</td>
