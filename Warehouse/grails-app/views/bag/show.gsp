	...
	<body>
		...
		<div id="show-bag" class="content scaffold-show" role="main">
			...
			<ol class="property-list bag">
				...
				<g:if test="${bagInstance?.EANCode}">
				<li class="fieldcontain">
					<span id="EANCode-label" class="property-label"><g:message code="bag.EANCode.label" default="EANC ode" /></span>
					
						<span class="property-value" aria-labelledby="EANCode-label"><g:fieldValue bean="${bagInstance}" field="EANCode"/></span>
