	...
	<body>
		...
		<div id="show-customer" class="content scaffold-show" role="main">
			...
			<ol class="property-list customer">
				...
				<g:if test="${customerInstance?.addressBook}">
				<li class="fieldcontain">
					<span id="addressBook-label" class="property-label"><g:message code="customer.addressBook.label" default="Address Book" /></span>
					
						<g:each in="${customerInstance.addressBook}" var="a">
				...
				<li class="fieldcontain">
					<span id="orders-label" class="property-label"><g:message code="customer.orders.label" default="Orders" /></span>
						...
						<span class="property-value" aria-labelledby="orders-label"><g:link controller="customerOrder" action="show" id="${o.id}">${o?.encodeAsHTML()}</g:link></span>
						</g:each>
