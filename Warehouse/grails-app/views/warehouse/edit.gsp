...
<html>
	...
	<body>
		<a href="#edit-warehouse" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-warehouse" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:warehouseInstance, action:'update']" method="PUT" >
