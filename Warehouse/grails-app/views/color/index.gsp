		...
		<div id="list-color" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="comment" title="${message(code: 'color.comment.label', default: 'Comment')}" />
				...
				<g:each in="${colorInstanceList}" status="i" var="colorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: colorInstance, field: "comment")}</td>
			...
			<div class="pagination">
				<g:paginate total="${colorInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
