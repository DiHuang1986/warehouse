	...
	<body>
		...
		<div id="show-color" class="content scaffold-show" role="main">
			...
			<ol class="property-list color">
				...
				<g:if test="${colorInstance?.comment}">
				<li class="fieldcontain">
					<span id="comment-label" class="property-label"><g:message code="color.comment.label" default="Comment" /></span>
					
						<span class="property-value" aria-labelledby="comment-label"><g:fieldValue bean="${colorInstance}" field="comment"/></span>
