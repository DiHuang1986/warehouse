		...
		<div id="list-stockInForm" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="fee" title="${message(code: 'stockInForm.fee.label', default: 'Fee')}" />
				...
				<g:each in="${stockInFormInstanceList}" status="i" var="stockInFormInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${stockInFormInstance.id}">${fieldValue(bean: stockInFormInstance, field: "fee")}</g:link></td>
					
						<td><g:formatDate date="${stockInFormInstance.inDate}" /></td>
