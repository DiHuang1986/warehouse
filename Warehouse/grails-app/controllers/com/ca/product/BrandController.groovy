...
class BrandController {
    ...
    def save(Brand brandInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'brandInstance.label', default: 'Brand'), brandInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'brandInstance.label', default: 'Brand'), params.id])
                redirect action: "index", method: "GET"
            }
