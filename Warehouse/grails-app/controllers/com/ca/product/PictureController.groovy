...
class PictureController {
    ...
    def save(Picture pictureInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'pictureInstance.label', default: 'Picture'), pictureInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'pictureInstance.label', default: 'Picture'), params.id])
                redirect action: "index", method: "GET"
            }
